package activities.UncornHornGrinder;
...
public class UnicornHornGrinder extends Task {
    ...
    public void execute(int type)  {
        ...
        switch (type) {
            case 1:
                if(getInventory().contains("Pestle and mortar")) getInventory().getItem("Pestle and mortar").interact();
                Sleep.sleepUntil(random(100, 300));
                if(getInventory().contains("Unicorn horn")) getInventory().getItem("Unicorn horn").interact();
                break;
            case 2:
                if (getInventory().getAmount("Unicorn horn") + getInventory().getAmount("Unicorn horn dust") == 27) {
